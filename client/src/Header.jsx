...
export default function Header() {
  ...
  return (
    <header className="flex justify-between bg-white pt-4 pb-4">
      <Link to={'/'} className="flex items-center gap-1 ml-auto mr-8">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 -rotate-90">
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
        </svg>
        <span className="font-bold text-xl">Booking</span>
      </Link>
      <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 mx-8 shadow-md shadow-gray-300">
        <div>Anywhere</div>
      ...
      <Link to={user ? '/account' : '/login'} className="flex items-center gap-2 ml-8 mr-auto border border-gray-300 rounded-full py-2 px-4 ">
